...
| `scryer` | yes | metadata and artwork lookups; its `0.0.0.0/0` egress rule was **deleted** rather than superseded. Full pipeline verified after routing — see `kube/lookie/scryer/README.md` |
